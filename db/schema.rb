...
ActiveRecord::Schema[7.1].define(version: 20_240_805_185_853) do
  ...
  create_table 'accounts', force: :cascade do |t|
    ...
    t.integer 'total_income', default: 0, null: false
    t.integer 'total_expense', default: 0, null: false
  ...
  create_table 'categories', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'user_id'
    t.index %w[user_id name], name: 'index_categories_on_user_id_and_name', unique: true
  ...
  create_table 'user_transactions', force: :cascade do |t|
    ...
    t.index ['account_id'], name: 'index_user_transactions_on_account_id'
